        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                ...
                <div class="widget-user-header text-white" style="background-image:url('./img/user-cover.jpg')">
                    <h3 class="widget-user-username">{{form.name | uperText}}</h3>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show" id="settings">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                    <input type="text" v-model="form.contact" class="form-control" id="inputContact" 
                                        :class="{ 'is-invalid': form.errors.has('contact') }" placeholder="Contact" >
